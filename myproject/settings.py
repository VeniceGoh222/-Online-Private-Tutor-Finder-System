...
SECRET_KEY = 'django-insecure-0$7wqswyyv=41ks2#13ix7%yy1*xv9=n0bulzqco8%yz)b)^mu'
...
# Add this if you have static files inside your app's 'static' folder
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'app/static'),
]

# This is used in production when you run 'collectstatic'
